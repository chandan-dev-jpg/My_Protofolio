    ...
    <section className="min-h-screen w-full bg-[#F8F3E1] text-black p-1">
      <div className="overflow-hidden px-4 sm:px-6 md:px-20 py-10 mt-28 md:mt-6">
        ...
        >
          ...
          explored, and challenges I've solved while growing as a Full Stack
          Developer. From frontend experiences to backend applications, every
          project has helped me learn, experiment, and become a better
          developer.
        </p>
      </div>

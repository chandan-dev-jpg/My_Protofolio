    ...
    <section className="w-full min-h-screen bg-cream flex items-center justify-center px-6">
      ...
      >
        ...
        <p
          ...
          "
        >
          Thanks for taking the time to explore my portfolio. I'm
          Chandan Behera, a passionate Full Stack Developer and
          fresher who enjoys building responsive, interactive, and
          user-friendly web applications. If you're looking for a
          developer who is eager to learn, solve problems, and create
          meaningful digital experiences, I'd love to connect with you.
        </p>
